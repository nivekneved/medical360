...
import { Building2, Edit3, Eye, Network, Stethoscope } from 'lucide-react';
  ...
  return (
    <>
      <AdminEntityManager<Doctor>
        ...
        subtitle="Manage internationally recognized chief surgeons, clinical specialty associations, and hospital affiliations"

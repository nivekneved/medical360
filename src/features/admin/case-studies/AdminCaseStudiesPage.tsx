...
export function AdminCaseStudiesPage() {
  ...
  const getInitialCaseStudy = (): CaseStudy => ({
    ...
    testimonial: 'Med360 coordinated every step flawlessly from visa to hospital admission.',
    testimonial_fr: 'Med360 a coordonné chaque étape de manière impeccable.',

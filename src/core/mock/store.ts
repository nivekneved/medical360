...
export const STORAGE_KEY = 'med360_mock_store_v9';
export const CONFIG_KEY = 'med360_mock_config_v9';

// Clean legacy localStorage keys to ensure new seed data & CMS content is immediately visible

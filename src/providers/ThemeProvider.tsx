...
export const THEME_PRESETS: ThemeDefinition[] = [
  {
    ...
    description: 'Signature Med360 clean white & medical forest green palette.',
    primaryColor: '#065f46',
    accentColor: '#10b981',
    previewBg: '#f8fafc',
    textColor: '#0f172a',
  ...
  },
  {
    ...
    description: 'Exact color match from official Med360 logo (Cyan #0EBCC6, Navy #03528C & Coral #F2443A).',
    primaryColor: '#03528c',
    accentColor: '#0ebcc6',
    previewBg: '#f8fcfe',
    textColor: '#081a2e',
